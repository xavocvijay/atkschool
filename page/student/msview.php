...
class page_student_msview extends Page {
	function init(){
		...
		// throw new Exception($_GET['class'].' '.$_GET['student']);
		...
		$marksheet=$c->ref('MS_Designer');
		$marksheet->tryLoadAny();
		...
		$this->api->add('H1',null,'header')->setAttr('align','center')->setHTML('<span class="hindi" style="font-size: 25px"><b>cky fou; efUnj mPp ek/;fed fo|ky; mn;iqj</b> </span>');
